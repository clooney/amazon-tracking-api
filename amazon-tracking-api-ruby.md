...
Create trackings (Max. 40 tracking numbers create in one call):
    ...
    begin
      params  = [{"tracking_number" => "TBA317837059733","courier_code"=>"amazon"},{"tracking_number" => "TBA317761975112","courier_code"=>"amazon"}]
...
Get status of the shipment:
    ...
    begin
      ...
      # params  = {"tracking_numbers" => "TBA317837059733,TBA317761975112","courier_code"=>"amazon"}
