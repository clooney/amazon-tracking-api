Amazon Tracking API - .Net
================================
Use .Net to track Amazon shipments with Amazon Tracking API.
      ...
      public class Test
      {
            ...
            static void Main(string[] args)
            {
              try
              {
                  ...
                  createTrackingParams.trackingNumber = "TBA317775852202";
                  createTrackingParams.courierCode = "amazon";
      ...
      public class Test
      {
            ...
            static void Main(string[] args)
            {
              try
              {
                  ...
                  # getTrackingResultsParams.trackingNumbers = "TBA317775852202,TBA317761975112";
                  getTrackingResultsParams.courierCode = "amazon";
