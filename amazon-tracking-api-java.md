Amazon Tracking API - Java
================================
Use Java to track Amazon shipments with Amazon Tracking API.
...
Create a tracking (Real-time tracking):
    ...
    package com.trackingmore.example.amazon;
    ...
    public class CreateAmazonTrackingExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                createTrackingParams.setTrackingNumber("TBA317775852202");
                createTrackingParams.setCourierCode("amazon");
...
Create trackings (Max. 40 tracking numbers create in one call):
    ...
    public class CreateAmazonTrackingsExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                createTrackingParams1.setTrackingNumber("TBA317761975112");
                createTrackingParams1.setCourierCode("amazon");
                
                CreateTrackingParams createTrackingParams2 = new CreateTrackingParams();
                createTrackingParams2.setTrackingNumber("TBA317837059733");
                createTrackingParams2.setCourierCode("amazon");
...
Get status of the shipment:
    ...
    public class GetAmazonTrackingExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                # trackingParams.setTrackingNumbers("TBA317775852202,TBA317837059733");
                trackingParams.setCourierCode("amazon");
...
Update a tracking by ID:
    ...
    public class UpdateAmazonTrackingExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                String idString = "98d15bc96483b8d713b8380b65372b9c";
