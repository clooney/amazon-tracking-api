Amazon Tracking API - Node.js
================================
Use Node.js to track Amazon shipments with Amazon Tracking API.
...
Create a tracking (Real-time tracking):
      ...
      const params = {
        'tracking_number': 'TBA317775852202',
        'courier_code': 'amazon',
        'order_number': '',
        'customer_name': '',
        'title': '',
...
Create trackings (Max. 40 tracking numbers create in one call):
    ...
    const params = [{
        'tracking_number': 'TBA317761975112',
        'courier_code':'amazon'
    },{
      'tracking_number': 'TBA317837059733',
      'courier_code':'amazon'
    }]
...
Update a tracking by ID:
    ...
    const idString = "98d15bc96483b8d713b8380b65372b9c"
